...
@WebServlet(name = "ArtGalleryListCtl", urlPatterns = {"/ctl/ArtGalleryListCtl"})
public class ArtGalleryListCtl extends BaseCtl {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<ArtGalleryBean> list = model.search(bean, pageNo, pageSize);
            List<ArtGalleryBean> next = model.search(bean, pageNo + 1, pageSize);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ArtGalleryBean> list = null;
        List<ArtGalleryBean> next = null;
        ...
        try {
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
                ...
                if (ids != null && ids.length > 0) {
                    ArtGalleryBean deleteBean = new ArtGalleryBean();
                    for (String id : ids) {
                        deleteBean.setId(DataUtility.getLong(id));
                        model.deleteArtwork(deleteBean.getId());
    ...
    protected String getView() {
        return ORSView.ART_GALLERY_LIST_VIEW;
    }
}